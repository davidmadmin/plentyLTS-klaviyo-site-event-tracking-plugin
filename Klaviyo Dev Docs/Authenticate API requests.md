...
Check out our video on \[client- and server-side tracking with Klaviyo's APIs](https://www.youtube.com/watch?v=x0RjkP8T13A\&list=PLHkNfHgtxcUanrkMnKPdkRzuWU7MGv\_xM\&index=3).
...
Private keys will have the prefix pk\_ followed by a longer alphanumeric string.
...
Client-side API calls only require a public API key, also known as a `company\_id`, for authentication:cURL



`curl --request POST \\

&nbsp;    --url 'https://a.klaviyo.com/client/subscriptions/?company\_id=PUBLIC\_API\_KEY' \\
...
If you're building an app with Klaviyo, use \[OAuth](https://developers.klaviyo.com/en/docs/set\_up\_oauth) to provide secure delegated access to users via access tokens (required to enter Klaviyo’s App Marketplace). When setting up OAuth, you must provide designated scopes for each API authorization request you'll want to make.
...
• \[Make API calls with OAuth](https://developers.klaviyo.com/en/docs/set\_up\_oauth)

• \[Use Klaviyo's Postman collections](https://developers.klaviyo.com/en/docs/use\_klaviyos\_postman\_collections)

• \[Introduction to the Klaviyo object](https://developers.klaviyo.com/en/docs/introduction\_to\_the\_klaviyo\_object)
...
• \[\*\*Table of Contents\*\*](https://developers.klaviyo.com/en/docs/authenticate\_#)

• 

&nbsp;   ◦ \[You will learn](https://developers.klaviyo.com/en/docs/authenticate\_#you-will-learn)

&nbsp;   ◦ \[Server-side vs client-side APIs](https://developers.klaviyo.com/en/docs/authenticate\_#server-side-vs-client-side-apis)

&nbsp;   ◦ \[Private key authentication](https://developers.klaviyo.com/en/docs/authenticate\_#private-key-authentication)

&nbsp;       ▪ \[Create a private key](https://developers.klaviyo.com/en/docs/authenticate\_#create-a-private-key)

&nbsp;       ▪ \[Use a private key](https://developers.klaviyo.com/en/docs/authenticate\_#use-a-private-key)

&nbsp;   ◦ \[Public key authentication](https://developers.klaviyo.com/en/docs/authenticate\_#public-key-authentication)

&nbsp;   ◦ \[OAuth](https://developers.klaviyo.com/en/docs/authenticate\_#oauth)

&nbsp;   ◦ \[Set custom scopes](https://developers.klaviyo.com/en/docs/authenticate\_#set-custom-scopes)

&nbsp;   ◦ \[Additional resources](https://developers.klaviyo.com/en/docs/authenticate\_#additional-resources)
...
!\[Settings page with button to create a private API key.](https://files.readme.io/63e519eead1977ef41682d9be32ba3ddedf16c969cb6c2d7186c08b752aada8f-create\_priv\_key.png)
...
!\[Created private key with its Read/Write access endpoints.](https://files.readme.io/cfd0b2644992669c753febf25d64a01d61ad35b4bb50480219908cd112540807-private\_key\_created.png)



!\[Create List API reference docs with lists:write scope highlighted](https://files.readme.io/1470bbc-v2\_scopes\_refdoc\_submit\_app.png)
...
• \[Events](https://developers.klaviyo.com/en/reference/get\_events)

• \[Profiles](https://developers.klaviyo.com/en/reference/get\_profiles)

• \[Lists](https://developers.klaviyo.com/en/reference/get\_lists)

• \[Metrics](https://developers.klaviyo.com/en/reference/get\_metrics)

• \[Flows](https://developers.klaviyo.com/en/reference/get\_flows)
...
• \[Changelog](https://developers.klaviyo.com/en/docs/changelog\_)

• \[SDK overview](https://developers.klaviyo.com/en/docs/sdk\_overview)
...
• \[Get started](https://developers.klaviyo.com/en/docs/get\_started)

• \[Install SDKs](https://developers.klaviyo.com/en/docs/sdk\_overview)\[Terms and Privacy](https://www.klaviyo.com/legal)\[Trademarks](https://www.klaviyo.com/legal/trademarks)\[Security](https://www.klaviyo.com/security)
...
\- • \[Install SDKs](https://developers.klaviyo.com/en/docs/sdk\_overview)
