...
```twig
\<!-- SSR:globals({{ TemplateContainer.getContext() | json_encode | raw }}) --\>
...
\- The importedf file is not excluded for the upload to your PlentyONE system, e.g. in the node_modules directory.
