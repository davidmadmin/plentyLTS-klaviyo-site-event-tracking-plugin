...
<img src="{{ plugin\_path("Placeholder") }}/images/placeholder.png">
...
In line 3, we specify the placeholder image by entering the path of the image. `{{ plugin\_path("Placeholder") }}` is equal to the resources folder in our plugin, i.e. the complete image path is \*\*Placeholder/resources/images/placeholder.png\*\*.
